...
import { AbsentStateManager } from "./handlers/absentStateManager";
...
class Client extends TSASN1BrowserClient implements IClientConnectionCallback {
	...
	public readonly eventManager: AbsentStateManager;
	...
	public constructor() {
		...
		this.eventManager = new AbsentStateManager(this);
